                      ...
                      const device float3x4* instanceWorldMat [[buffer(2)]])
{
    ...
    // Disable degenerated triangles
    if (dot(patch.b030 - patch.b300, patch.b030 - patch.b300) == 0.0
        || dot(patch.b003 - patch.b030, patch.b003 - patch.b030) == 0.0
        || dot(patch.b300 - patch.b003, patch.b300 - patch.b003) == 0.0) {
